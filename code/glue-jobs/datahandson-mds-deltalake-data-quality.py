...
def process_suite_ge(spark, input_path, output_path):
    ...
    results = df_validator_movies.validate(expectation_suite=suite_movies)
    ...
    results = df_validator_tags.validate(expectation_suite=suite_tags)
...
if __name__ == "__main__":
    input_path = 's3://cjmm-datalake-mds-curated/movielens_delta_glue'
